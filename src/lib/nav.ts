...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Đơn online", href: "/{store}/orders", roles: ["sadmin", "admin", "accountant", "staff"] },
  ...
  { label: "Công nợ", href: "/{store}/payables", roles: ["sadmin", "admin", "accountant"] },
  { label: "Thu chi", href: "/{store}/cash", roles: ["sadmin", "admin", "accountant", "staff"] },
  { label: "Báo cáo", href: "/{store}/reports", roles: ["sadmin", "admin", "accountant"] },
